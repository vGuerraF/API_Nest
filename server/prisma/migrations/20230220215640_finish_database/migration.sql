/*
  ...
  - Added the required column `classroomStudentsId` to the `User` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "classroomStudentsId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_classroomStudentsId_fkey" FOREIGN KEY ("classroomStudentsId") REFERENCES "Classroom"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
